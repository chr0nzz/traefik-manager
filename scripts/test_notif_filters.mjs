...
const i18n = readFileSync(join(root, 'static', 'js', 'i18n.js'), 'utf8');
const harness = `
const window = {};
(function (window, document) {
${i18n}
})(window, { getElementById: () => null, documentElement: { lang: 'en' } });
const { t, tn, tc, th, thn, thc, tmHtml } = window;
${labels}
${icons}
let _notifData = [];
let _notifCatFilter = '';
...
const i18nPrelude = `const window = {};
(function (window, document) {
${i18n}
})(window, { getElementById: () => null, documentElement: { lang: 'en' } });
const { t, tn, tc, th, thn, thc, tmHtml } = window;`;
